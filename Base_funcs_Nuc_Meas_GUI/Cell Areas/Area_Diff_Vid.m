function [vid_Stacked,Percents] = Area_Diff_Vid(Frame_num,pixscale,handles)
...
disp('Saving area difference video to current Matlab directory path')
y = VideoWriter('Area_Diffs_Video.avi', 'Uncompressed AVI');
y.FrameRate = 20; %Default framerate for GUI saved videos
open(y)
writeVideo(y,vid_Stacked)
close(y)
end