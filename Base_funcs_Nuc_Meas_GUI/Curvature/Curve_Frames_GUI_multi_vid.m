function [Curve_Video] = Curve_Frames_GUI_multi_vid(Frames_mask,Cell_Frames)
%function for multi-frame curvature analysis with save videos checked
disp('Displaying outlines with curvature overlaid')
...
disp('Saving video to current Matlab directory path')
y = VideoWriter('Curve_Video.avi', 'Uncompressed AVI');
y.FrameRate = 20;
open(y)
